    ...
    <>
      <div
        style={{
          ...
          backgroundImage: `url(${"https://cdn.pixabay.com/photo/2017/09/22/07/28/home-2774669_1280.jpg"})`,
      ...
      <div className="w-full bg-white">
        <div className="bg-white p-6 md:p-10 rounded-xl shadow-2xl max-w-lg mx-auto border border-gray-100">
